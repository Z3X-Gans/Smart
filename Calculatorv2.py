...
print("Blog : https://bojonegoroprogrammer.zone.id")
print("Notify : No Recode Ea,Buat Sendiri")
print("Indonesian Programmer")
print("Pilih Operasi.") print("1.Jumlah") 
print("2.Kurang") 
print("3.Kali") 
print("4.Bagi") 

# Meminta input dari user choice = input("Masukkan pilihan(1/2/3/4): ")
